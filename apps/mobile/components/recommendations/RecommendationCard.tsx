        ...
        >
          ...
          <View style={{ flexDirection: "row", alignItems: "center", padding: 16, paddingBottom: 12 }}>
            ...
            <View style={{ flex: 1, marginLeft: 14 }}>
              ...
              <Text numberOfLines={2} style={{ color: c.text, fontSize: 16, fontWeight: "700", lineHeight: 21 }}>
                {rec.title}
              </Text>
            </View>
          </View>
          ...
          <View style={{ paddingHorizontal: 16, paddingBottom: 12 }}>
            <Text numberOfLines={2} style={{ color: c.textMuted, fontSize: 13, lineHeight: 19 }}>
              {rec.summary}
            </Text>
          </View>
          ...
          {firstStepTitle.length > 0 && (
            <View style={{ marginHorizontal: 16, marginBottom: 12, backgroundColor: `${theme.accent}14`, borderRadius: 14, padding: 12, flexDirection: "row", gap: 10, alignItems: "center" }}>
          ...
          {/* Footer: metadata + CTA */}
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 16, paddingVertical: 12, borderTopWidth: 0.5, borderTopColor: c.borderLight }}>
