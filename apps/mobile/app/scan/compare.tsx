...
function scoreColor(s: number) {
  return s >= 75 ? "#4ade80" : s >= 50 ? "#C9A96E" : "#f87171";
}
          ...
          return (
            <TouchableOpacity
              ...
              style={{
                ...
                borderWidth: 1, borderColor: isSel ? "#C9A84C" : "rgba(255,255,255,0.1)",
                borderRadius: 12, paddingHorizontal: 14, paddingVertical: 8, alignItems: "center", minWidth: 64,
              }}
            >
              <Text style={{ color: isSel ? "#C9A84C" : "#fff", fontWeight: "700", fontSize: 15 }}>{s.overall_score}</Text>
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#0A0A0A" }}>
      ...
      {history.length < 2 ? (
        <View style={{ flex: 1, alignItems: "center", justifyContent: "center", padding: 32 }}>
          ...
          <TouchableOpacity onPress={() => router.replace("/(tabs)/scan")} style={{ backgroundColor: "#C9A84C", borderRadius: 14, paddingHorizontal: 24, paddingVertical: 12 }}>
            <Text style={{ color: "#0A0A0A", fontWeight: "700" }}>📸 Faire un scan</Text>
          </TouchableOpacity>
        </View>
      ) : (
        <ScrollView contentContainerStyle={{ paddingHorizontal: 16, paddingBottom: 40 }}>
          {/* Pickers */}
          <View style={{ backgroundColor: "rgba(255,255,255,0.04)", borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", borderRadius: 16, padding: 14, marginBottom: 16 }}>
            ...
            <>
              ...
              <Animated.View entering={FadeInDown} style={{ flexDirection: "row", gap: 12, marginBottom: 16 }}>
                {[before, after].map((s, i) => {
                  ...
                  return (
                    <View key={i} style={{ flex: 1, backgroundColor: "rgba(255,255,255,0.04)", borderWidth: 1, borderColor: `${oc}40`, borderRadius: 18, padding: 16, alignItems: "center" }}>
              ...
              <Animated.View entering={FadeInDown.delay(80)} style={{ alignItems: "center", marginBottom: 16 }}>
                {(() => {
                  ...
                  return (
                    <View style={{ backgroundColor: `${c}15`, borderWidth: 1, borderColor: `${c}40`, borderRadius: 14, paddingHorizontal: 18, paddingVertical: 12 }}>
              ...
              {/* Metric breakdown */}
              <Animated.View entering={FadeInDown.delay(160)} style={{ backgroundColor: "rgba(255,255,255,0.04)", borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", borderRadius: 18, padding: 16 }}>
